...
export type QaTransportAdapter = Awaited<
...
export function createQaStateBackedTransportAdapter(
  ...
  params: Omit<
    QaTransportAdapter,
    "reset" | "sendInbound" | "state" | "waitForCondition" | "waitForNoOutbound" | "waitForOutbound"
  > & {
    assertTransportHealthy?: () => void;
    resetTransport?: () => void | Promise<void>;
    sendInbound: QaTransportAdapter["sendInbound"];
  },
): QaTransportAdapter {
