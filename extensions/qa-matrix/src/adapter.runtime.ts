...
async function waitForMatrixChannelReady(
  gateway: Parameters<Parameters<FactoryContext["createAdapter"]>[0]["waitReady"]>[0]["gateway"],
  accountId: string,
  timeoutMs = 60_000,
  pollIntervalMs = 500,
) {
...
export async function createMatrixQaTransportAdapter(context: FactoryContext) {
